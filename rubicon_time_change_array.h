...
public:
    ...
    void get_measure_range_for_time_change(Array p_range) const;
    void get_beat_range_for_time_change(Array p_range) const;
    void get_step_range_for_time_change(Array p_range) const;
